  ...
  return (
    <div className="mx-auto overflow-hidden flex  max-w-sm items-center rounded-xl bg-white  shadow-lg outline m-8 outline-black/5">
      <div class="">
        ...
        <h3 className="text-3xl font-bold leading text-black my-5">
          {props.title}
        </h3>
        ...
        <p className="text-gray-500 text-left text-xs ml-8 mt-4">Tech used</p>
        <div className="ml-8 flex flex-justify-center text-centerm-4 h-11">
          <svg viewBox="0 0 200 200">
            <path fill="#357766" d="M1.408 1.408h125.184v125.185H1.408z"></path>
            <path
              fill="#FFFFFF"
